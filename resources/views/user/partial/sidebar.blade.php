<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
      ...
      <li class="nav-item">
        <a class="nav-link" data-toggle="" href="{{url('request-report')}}" aria-expanded="false"
      ...
      <li class="nav-item">
          <a class="nav-link" data-toggle="" href="{{url('sku-registration')}}" aria-expanded="false"
      ...
      <li class="nav-item">
        <a class="nav-link" data-toggle="" href="{{url('vendor-registration')}}" aria-expanded="false"
            aria-controls="ui-basic">
            <i class="typcn typcn-document-text menu-icon"></i>
...
{{--   
      <li class="nav-item">
        <a class="nav-link" href="{{url('message-list')}}" aria-expanded="false"
        aria-controls="form-elements">
            <i class="fa-regular fa-message"></i>
            <span class="ml-3 menu-title">Message</span>
