                                ...
                                <tbody>
                                    ...
                                    @foreach ($skuProducts as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item['price'] }}</td>                
                                            <td>
                                                {{-- <a href="{{ url('edit-vendor-registration-detail/' . $item->id) }}" class="btn-submit btn-edit mr-2"><i
                                                class="fa-solid fa-pen-to-square"></i></a> --}}

                                                <a href="{{ url('delete-sku-vendor-entity-detail/' . $item->id) }}" class="btn-submit btn-remove" onclick="return confirmDelete()"><i class="fa-solid fa-trash-can"></i></a>
                                            </td>
                                            <td>
